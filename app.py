...
with st.sidebar:
    ...
    if logo_path.exists():
        ...
        st.markdown('<div class="sidebar-tagline">University Result Processing Platform</div>',
                    unsafe_allow_html=True)
    ...
    selected_page = st.radio(
        "Navigation",
        ["📤 Upload & Parse", "📊 Analytics Dashboard", "📋 History", "⚙️ System Stats"],
    ...
    st.markdown(
        _social_btn("https://github.com/himanshu-jadhav108",
                    "#1a1a1a; border:1px solid #555", _GITHUB_SVG, "GitHub Profile") +
        _social_btn("https://www.linkedin.com/in/himanshu-jadhav-328082339",
                    "#0a66c2", _LINKEDIN_SVG, "LinkedIn") +
        _social_btn("https://www.instagram.com/himanshu_jadhav_108",
                    "linear-gradient(135deg,#833ab4 0%,#fd1d1d 50%,#fcb045 100%)",
                    _INSTA_SVG, "Instagram") +
        _social_btn("https://himanshu-jadhav-portfolio.vercel.app/",
                    "linear-gradient(135deg,#1a4a8a,#2d8cff)", _WEB_SVG, "Portfolio"),
        unsafe_allow_html=True,
    )
